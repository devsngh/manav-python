...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/prompts/{prompt_id}".format(
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = PromptDetailResponse.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    """Get Prompt
     ...
     Get a specific prompt by ID (own-scoped: your own only; admin: any).
