...
from ...models.dialogue_like import DialogueLike
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/chat/dialogues/{dialogue_id}/dislike".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Toggle Dislike
     ...
     Dislike or un-dislike a dialogue response

    - **is_liked**: true to dislike, false to un-dislike (reusing same schema)

    Args:
        dialogue_id (UUID):
        authorization (None | str | Unset): Bearer token
        body (DialogueLike): Schema for liking/unliking a dialogue
