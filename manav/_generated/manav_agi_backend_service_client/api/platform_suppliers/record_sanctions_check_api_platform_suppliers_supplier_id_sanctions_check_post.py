...
from ...models.sanctions_check_request import SanctionsCheckRequest
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/platform/suppliers/{supplier_id}/sanctions-check".format(
