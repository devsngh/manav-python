...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/analytics/cost-breakdown",
        "params": params,
    }
...
) -> CostBreakdownResponse | HTTPValidationError | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[CostBreakdownResponse | HTTPValidationError]:
    return Response(
...
def sync_detailed(
    *,
    ...
    """Get Cost Breakdown
     ...
     Per-model: tokens, credits, % of total.
...
def sync(
    *,
    ...
    Returns:
        CostBreakdownResponse | HTTPValidationError
    """
