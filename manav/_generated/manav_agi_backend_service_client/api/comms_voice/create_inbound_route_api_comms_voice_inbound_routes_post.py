...
from ...models.voice_inbound_route_create import VoiceInboundRouteCreate
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 201:
        response_201 = VoiceInboundRouteRead.from_dict(response.json())
