...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/platform/brand/voice/{guidelines_id}/activate".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Activate Brand Voice Version

     Atomically activate this version + deactivate all others for the org.
