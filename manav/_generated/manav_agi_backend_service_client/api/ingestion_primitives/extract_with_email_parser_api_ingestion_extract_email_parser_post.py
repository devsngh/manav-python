...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/ingestion/extract/email_parser",
    }
...
def sync_detailed(
    *,
    ...
    """Extract With Email Parser

     Parse an email file (.eml or .msg-style) using stdlib email module.

    Primitive: returns headers + plain text body + HTML body + attachment list.
    Agent decides which body to use (plain vs html) and whether to ingest
