...
from ...models.delete_node_request import DeleteNodeRequest
...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/ingestion/neo4j/delete-node",
    }
...
def sync_detailed(
    *,
    ...
    """Neo4J Delete Node
     ...
     Delete a node by label + key. If cascade=True, removes connected edges too.
