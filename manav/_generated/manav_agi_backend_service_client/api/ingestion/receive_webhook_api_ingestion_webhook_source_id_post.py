...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/ingestion/webhook/{source_id}".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Receive Webhook
     ...
     Receive a raw event payload from an external stream (Kafka forwarder,
    RSS poller, NewsAPI, or any webhook). No auth — secured by source_id
    being a non-guessable UUID.
