...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/ingestion/sources/{source_id}/sync".format(
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 202:
        response_202 = SyncResponse.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    """Sync Source
     ...
     Manually trigger a full re-sync of a structured source (DB schema).
