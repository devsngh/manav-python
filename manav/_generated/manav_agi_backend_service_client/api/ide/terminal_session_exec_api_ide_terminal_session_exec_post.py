...
from ...models.session_exec_request import SessionExecRequest
...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/ide/terminal/session/exec",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    """Terminal Session Exec
     ...
     Execute command in a persistent shell session (cd/env persists).
