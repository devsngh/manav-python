...
from ...models.body_upload_banner_api_marketplace_publish_listing_id_banner_post import (
...
def _get_kwargs(
    listing_id: UUID,
    *,
    body: BodyUploadBannerApiMarketplacePublishListingIdBannerPost,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/marketplace/publish/{listing_id}/banner".format(
