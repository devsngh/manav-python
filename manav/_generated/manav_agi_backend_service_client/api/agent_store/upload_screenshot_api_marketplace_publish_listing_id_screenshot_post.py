...
from ...models.body_upload_screenshot_api_marketplace_publish_listing_id_screenshot_post import (
...
def _get_kwargs(
    listing_id: UUID,
    *,
    body: BodyUploadScreenshotApiMarketplacePublishListingIdScreenshotPost,
