...
from ...models.currency_create import CurrencyCreate
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 201:
        response_201 = CurrencyResponse.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    """Create Currency
     ...
     Create a new currency. (Admin only — TODO: add RBAC check)
