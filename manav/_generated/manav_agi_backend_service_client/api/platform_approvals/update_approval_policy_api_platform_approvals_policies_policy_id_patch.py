...
from ...models.approval_policy_update import ApprovalPolicyUpdate
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": "/api/platform/approvals/policies/{policy_id}".format(
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = ApprovalPolicyResponse.from_dict(response.json())
