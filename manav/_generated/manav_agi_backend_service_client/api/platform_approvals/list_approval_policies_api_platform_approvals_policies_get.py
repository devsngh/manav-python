...
from ...models.approval_policy_list_response import ApprovalPolicyListResponse
...
) -> ApprovalPolicyListResponse | HTTPValidationError | None:
    if response.status_code == 200:
        response_200 = ApprovalPolicyListResponse.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ApprovalPolicyListResponse | HTTPValidationError]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        ApprovalPolicyListResponse | HTTPValidationError
    """
