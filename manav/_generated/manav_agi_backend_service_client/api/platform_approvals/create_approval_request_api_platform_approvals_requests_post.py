...
from ...models.approval_request_create import ApprovalRequestCreate
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 201:
        response_201 = ApprovalRequestResponse.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    """Create Approval Request
     ...
     Create a request. Auto-creates one step per policy rule unless auto_create_steps=false.
