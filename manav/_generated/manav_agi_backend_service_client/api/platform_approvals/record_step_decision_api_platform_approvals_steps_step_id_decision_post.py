...
from ...models.record_step_decision_request import RecordStepDecisionRequest
...
def _get_kwargs(
    step_id: UUID,
    *,
    body: RecordStepDecisionRequest,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/platform/approvals/steps/{step_id}/decision".format(
