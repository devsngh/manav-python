...
from ...models.mark_acquired_request import MarkAcquiredRequest
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/platform/competitors/{competitor_id}/mark-acquired".format(
