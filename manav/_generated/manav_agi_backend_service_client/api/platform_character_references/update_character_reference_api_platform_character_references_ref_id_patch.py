...
from ...models.character_reference_update import CharacterReferenceUpdate
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": "/api/platform/character-references/{ref_id}".format(
