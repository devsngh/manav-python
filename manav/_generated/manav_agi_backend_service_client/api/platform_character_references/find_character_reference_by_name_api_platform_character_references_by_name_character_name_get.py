...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/platform/character-references/by-name/{character_name}".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Find Character Reference By Name

    Args:
        character_name (str):
        version (None | str | Unset): Specific version (else latest active)
