...
from ...models.bot_group_create import BotGroupCreate
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 201:
        response_201 = BotGroupResponse.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        body (BotGroupCreate): Schema for creating a bot group
