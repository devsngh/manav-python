...
from ...models.main_channel_message_create import MainChannelMessageCreate
...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/social/channel/messages",
    }
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 201:
        response_201 = MainChannelMessageResponse.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        body (MainChannelMessageCreate): Schema for posting to main channel
