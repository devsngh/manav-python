...
from ...models.user_group_create import UserGroupCreate
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 201:
        response_201 = UserGroupResponse.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        body (UserGroupCreate): Schema for creating a user group
