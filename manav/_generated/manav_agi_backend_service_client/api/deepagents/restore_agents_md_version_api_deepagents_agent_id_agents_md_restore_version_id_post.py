...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/deepagents/{agent_id}/agents-md/restore/{version_id}".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Restore Agents Md Version

     Restore agents_md_content from a previous version (own-scoped: your own only; admin: any).
