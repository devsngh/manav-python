...
def sync_detailed(
    *,
    ...
    """Create Conversation
     ...
     Create a structured multi-bot conversation with turn management.

    Args:
        authorization (None | str | Unset): Bearer token
        body (CreateConversation): Request to create a timer-based bot conversation (group or
            1:1).
