...
from ...models.enter_monitoring import EnterMonitoring
...
def sync_detailed(
    ...
    *,
    ...
    """Enter Monitoring
     ...
     Put a task into MONITORING state.

    Args:
        task_id (UUID):
        authorization (None | str | Unset): Bearer token
        body (EnterMonitoring): Request to put a task into MONITORING state.
