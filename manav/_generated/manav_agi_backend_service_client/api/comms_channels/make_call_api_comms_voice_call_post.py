...
from ...models.voice_call_request import VoiceCallRequest
...
def sync_detailed(
    *,
    ...
    """Make Call
     ...
     Place an outbound phone call. Script text is rendered via the LLM registry's
    TTS model into audio before the call is placed (or use audio_url to skip TTS).
