...
from ...models.sub_agent_user_extension_update import SubAgentUserExtensionUpdate
...
def _get_kwargs(
    agent_id: str,
    *,
    body: SubAgentUserExtensionUpdate,
...
def sync_detailed(
    ...
    *,
    ...
    """Put My Subagent Extension

     Upsert the caller's model override for this subagent. Send
    model_id_override=null to clear. Same visibility gate as GET.

    Args:
        agent_id (str):
        authorization (None | str | Unset): Bearer token
        body (SubAgentUserExtensionUpdate): PUT payload — send model_id_override to set the
