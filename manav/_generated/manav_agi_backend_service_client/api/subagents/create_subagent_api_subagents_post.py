...
from ...models.sub_agent_create import SubAgentCreate
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 201:
        response_201 = SubAgentResponse.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    """Create Subagent
     ...
     Create a new subagent. The caller is stamped as owner (created_by).
