...
from ...models.agent_target_update import AgentTargetUpdate
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": "/api/observability/targets/{target_id}".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Update Target Progress
     ...
     Update current_value, evidence_refs, status. Status auto-recomputed
    from pace if caller doesn't pass it explicitly.

    Args:
        target_id (UUID):
        authorization (None | str | Unset): Bearer token
        body (AgentTargetUpdate): Patch — set any subset.
