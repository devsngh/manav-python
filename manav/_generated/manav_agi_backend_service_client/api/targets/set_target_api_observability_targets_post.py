...
from ...models.agent_target_create import AgentTargetCreate
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 201:
        response_201 = AgentTargetResponse.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    """Set Target
     ...
     Set a new target — manual / mcp_pull / derived sources supported.
