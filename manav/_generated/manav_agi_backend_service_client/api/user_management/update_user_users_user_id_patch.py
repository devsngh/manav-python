...
from ...models.user_update_by_admin import UserUpdateByAdmin
...
def sync_detailed(
    ...
    *,
    ...
    """Update User
     ...
     Update user by admin (Super Admin only)
    ...
    - Role (use separate endpoint)
    - Password (use separate endpoint)

    Args:
        user_id (UUID):
        authorization (None | str | Unset): Bearer token
        body (UserUpdateByAdmin): Update user by admin
