...
from ...models.email_send_request import EmailSendRequest
...
def sync_detailed(
    *,
    ...
    """Send Email
     ...
     Send an external email through the org's active email datasource.

    Args:
        authorization (None | str | Unset): Bearer token
        body (EmailSendRequest): High-level send request — provider is resolved via Datasource.
