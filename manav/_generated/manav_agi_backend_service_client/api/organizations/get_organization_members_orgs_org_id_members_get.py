...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/orgs/{org_id}/members".format(
...
) -> HTTPValidationError | OrganizationMemberListResponse | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[HTTPValidationError | OrganizationMemberListResponse]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        HTTPValidationError | OrganizationMemberListResponse
    """
