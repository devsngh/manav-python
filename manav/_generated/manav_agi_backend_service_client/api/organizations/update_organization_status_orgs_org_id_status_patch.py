...
from ...models.organization_status_update import OrganizationStatusUpdate
...
def sync_detailed(
    ...
    *,
    ...
    """Update Organization Status
     ...
     Enable/Disable organization (Super Admin only)
    ...
    Args:
        ...
        body (OrganizationStatusUpdate): Schema for updating organization status
