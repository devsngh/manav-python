...
def _get_kwargs(
    *,
    ...
    secondary_by: None | str | Unset = UNSET,
    ...
    json_secondary_by: None | str | Unset
    if isinstance(secondary_by, Unset):
        json_secondary_by = UNSET
    else:
        json_secondary_by = secondary_by
    params["secondary_by"] = json_secondary_by
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/system-logs/traces/clusters",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    """Get Trace Clusters
     ...
     Panel 1 Level 0 — grouped cluster rows over root HTTP spans.

    Args:
        cluster_by (str | Unset): Cluster key Default: 'endpoint'.
        secondary_by (None | str | Unset): Optional nested cluster key ('none' or a key)
        search (None | str | Unset): ILIKE match on path/operation
        status (None | str | Unset): OK or ERROR
        ...
        focus_org_id (None | str | Unset): Filter to one org (super-admin only)
        method (None | str | Unset): HTTP method (GET/POST/…)
        max_duration_ms (float | None | Unset): Only include ≤ this duration
        cross_service_only (bool | Unset): Only traces spanning >1 service Default: False.
        initiator_kind (None | str | Unset): agent/user/system/infra/external
