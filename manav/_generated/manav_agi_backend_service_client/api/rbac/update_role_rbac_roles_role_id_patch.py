...
def sync_detailed(
    ...
    *,
    ...
    """Update Role
     ...
     Update role. Delegated: a non-admin org-admin may only update a role in THEIR org
    (never a system/global role or another org's).

    Args:
        role_id (UUID):
        authorization (None | str | Unset): Bearer token
        body (RoleUpdate): Update role schema
