...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": "/api/llm/my-configs/{config_id}/toggle".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Toggle User Config
     ...
     Toggle user config enabled status. Beta freeze: disabling a
    locked key is treated the same as removing it — refuse when the
