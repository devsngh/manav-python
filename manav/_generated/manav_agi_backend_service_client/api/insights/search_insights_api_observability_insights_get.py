...
from ...models.synthesis_insight_list_response import SynthesisInsightListResponse
...
) -> HTTPValidationError | SynthesisInsightListResponse | None:
    if response.status_code == 200:
        response_200 = SynthesisInsightListResponse.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[HTTPValidationError | SynthesisInsightListResponse]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        HTTPValidationError | SynthesisInsightListResponse
    """
