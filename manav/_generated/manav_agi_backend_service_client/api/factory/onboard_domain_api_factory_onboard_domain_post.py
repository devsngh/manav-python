...
from ...models.onboard_domain_request import OnboardDomainRequest
from ...types import UNSET, Response, Unset


def _get_kwargs(
    *,
    body: OnboardDomainRequest,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/factory/onboard-domain",
    }
...
def sync_detailed(
    *,
    ...
    """Onboard Domain
     ...
     Create a complete department with bot, config, and social group.
