...
from ...models.bulk_create_tasks_request import BulkCreateTasksRequest
...
def sync_detailed(
    *,
    ...
    """Bulk Create Tasks
     ...
     Create multiple tasks in one transaction with name-based assignment.
    Same org-scoping as /task-tree.
