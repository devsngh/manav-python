...
from ...models.deprecate_sub_agent_request import DeprecateSubAgentRequest
...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/factory/deprecate-subagent",
    }
...
def sync_detailed(
    *,
    ...
    """Deprecate Subagent
     ...
     Deprecate a subagent and remove from all configs.
