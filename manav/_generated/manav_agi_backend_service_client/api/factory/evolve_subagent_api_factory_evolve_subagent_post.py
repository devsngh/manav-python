...
from ...models.evolve_sub_agent_request import EvolveSubAgentRequest
...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/factory/evolve-subagent",
    }
...
def sync_detailed(
    *,
    ...
    """Evolve Subagent
     ...
     Clone a subagent, apply changes, deprecate old, swap in all configs.
