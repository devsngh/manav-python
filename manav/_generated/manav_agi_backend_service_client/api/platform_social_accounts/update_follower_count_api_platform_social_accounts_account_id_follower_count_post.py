...
from ...models.update_follower_count_request import UpdateFollowerCountRequest
...
def _get_kwargs(
    account_id: UUID,
    *,
    body: UpdateFollowerCountRequest,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/platform/social-accounts/{account_id}/follower-count".format(
