...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/platform/social-accounts/by-external/{platform}/{external_account_id}".format(
            platform=quote(str(platform), safe=""),
            external_account_id=quote(str(external_account_id), safe=""),
        ),
    }
...
def sync_detailed(
    ...
    *,
    ...
    """Find Social Account By External Id
