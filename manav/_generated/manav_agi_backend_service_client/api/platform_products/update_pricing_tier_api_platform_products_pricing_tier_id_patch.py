...
from ...models.product_pricing_tier_update import ProductPricingTierUpdate
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": "/api/platform/products/pricing/{tier_id}".format(
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = ProductPricingTierResponse.from_dict(response.json())
