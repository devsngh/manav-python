...
def _get_kwargs(
    ...
    *,
    ...
    json_sunsetted_at: None | str | Unset
    if isinstance(sunsetted_at, Unset):
        json_sunsetted_at = UNSET
    elif isinstance(sunsetted_at, datetime.datetime):
        json_sunsetted_at = sunsetted_at.isoformat()
    else:
        json_sunsetted_at = sunsetted_at
    params["sunsetted_at"] = json_sunsetted_at

    params = {k: v for k, v in params.items() if v is not UNSET and v is not None}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/platform/products/{product_id}/sunset".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Sunset Product
     ...
     Transition active → sunset and set sunsetted_at.
