...
from ...models.transformation_proposal_create import TransformationProposalCreate
...
def _get_kwargs(
    *,
    body: TransformationProposalCreate,
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 201:
        response_201 = TransformationProposalResponse.from_dict(response.json())
