...
from ...models.billing_plan_create import BillingPlanCreate
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 201:
        response_201 = BillingPlanResponse.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    """Create Plan
     ...
     billing_admin:create — create a new plan.
