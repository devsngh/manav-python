...
from ...models.plan_feature_create import PlanFeatureCreate
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/billing/plans/{plan_id}/features".format(
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 201:
        response_201 = PlanFeatureResponse.from_dict(response.json())
