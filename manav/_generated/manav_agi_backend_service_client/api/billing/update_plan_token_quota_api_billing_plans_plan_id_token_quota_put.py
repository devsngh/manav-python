...
from ...models.plan_token_quota_create import PlanTokenQuotaCreate
...
def sync_detailed(
    ...
    *,
    ...
    """Update Plan Token Quota

     Admin — create or update plan's token quota config.
