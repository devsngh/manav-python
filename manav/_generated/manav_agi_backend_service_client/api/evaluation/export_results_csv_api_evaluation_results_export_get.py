...
def _get_kwargs(
    *,
    ...
    eval_type: None | str | Unset = UNSET,
    ...
    json_eval_type: None | str | Unset
    if isinstance(eval_type, Unset):
        json_eval_type = UNSET
    else:
        json_eval_type = eval_type
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/evaluation/results/export",
        "params": params,
    }
