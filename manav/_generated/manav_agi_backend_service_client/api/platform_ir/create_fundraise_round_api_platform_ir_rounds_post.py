...
from ...models.fundraise_round_create import FundraiseRoundCreate
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 201:
        response_201 = FundraiseRoundResponse.from_dict(response.json())
