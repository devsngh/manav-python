...
from ...models.record_subscription_doc_request import RecordSubscriptionDocRequest
...
def _get_kwargs(
    commitment_id: UUID,
    *,
    body: RecordSubscriptionDocRequest,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/platform/ir/commitments/{commitment_id}/subscription-doc".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Record Commitment Subscription Doc
