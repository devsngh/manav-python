...
T = TypeVar("T", bound="RecordSignatureRequest")


@_attrs_define
class RecordSignatureRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        record_signature_request.additional_properties = d
        return record_signature_request
