...
if TYPE_CHECKING:
    from ..models.account_create_metadata_type_0 import AccountCreateMetadataType0
    from ..models.account_create_social_handles_type_0 import AccountCreateSocialHandlesType0
...
class AccountCreate:
    ...
    Attributes:
        ...
        account_type (None | str | Unset): prospect / customer / churned / partner
        industry (None | str | Unset):
        size_segment (None | str | Unset): enterprise / mid_market / smb / startup
        ...
        tier (None | str | Unset):
        social_handles (AccountCreateSocialHandlesType0 | None | Unset):
        metadata (AccountCreateMetadataType0 | None | Unset):
    """
    ...
    social_handles: AccountCreateSocialHandlesType0 | None | Unset = UNSET
    metadata: AccountCreateMetadataType0 | None | Unset = UNSET
    additional_properties: dict[str, Any] = _attrs_field(init=False, factory=dict)

    def to_dict(self) -> dict[str, Any]:
        from ..models.account_create_metadata_type_0 import AccountCreateMetadataType0  # noqa: PLC0415
        from ..models.account_create_social_handles_type_0 import AccountCreateSocialHandlesType0  # noqa: PLC0415
        ...
        elif isinstance(self.social_handles, AccountCreateSocialHandlesType0):
        ...
        if isinstance(self.metadata, Unset):
            metadata = UNSET
        elif isinstance(self.metadata, AccountCreateMetadataType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_social_handles(data: object) -> AccountCreateSocialHandlesType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                social_handles_type_0 = AccountCreateSocialHandlesType0.from_dict(data)

                return social_handles_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(AccountCreateSocialHandlesType0 | None | Unset, data)

        social_handles = _parse_social_handles(d.pop("social_handles", UNSET))

        def _parse_metadata(data: object) -> AccountCreateMetadataType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                metadata_type_0 = AccountCreateMetadataType0.from_dict(data)

                return metadata_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(AccountCreateMetadataType0 | None | Unset, data)
