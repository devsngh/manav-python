...
if TYPE_CHECKING:
    from ..models.employee_create_metadata_type_0 import EmployeeCreateMetadataType0


T = TypeVar("T", bound="EmployeeCreate")
...
class EmployeeCreate:
    ...
    Attributes:
        ...
        employment_status (str | Unset):  Default: 'active'.
        ...
        bio (None | str | Unset):
        metadata (EmployeeCreateMetadataType0 | None | Unset):
    """
    ...
    employment_status: str | Unset = "active"
    ...
    metadata: EmployeeCreateMetadataType0 | None | Unset = UNSET
    additional_properties: dict[str, Any] = _attrs_field(init=False, factory=dict)

    def to_dict(self) -> dict[str, Any]:
        from ..models.employee_create_metadata_type_0 import EmployeeCreateMetadataType0  # noqa: PLC0415
        ...
        manager_employee_id: None | str | Unset
        if isinstance(self.manager_employee_id, Unset):
            manager_employee_id = UNSET
        elif isinstance(self.manager_employee_id, UUID):
        ...
        if isinstance(self.metadata, Unset):
            metadata = UNSET
        elif isinstance(self.metadata, EmployeeCreateMetadataType0):
        ...
        if manager_employee_id is not UNSET:
            field_dict["manager_employee_id"] = manager_employee_id
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_manager_employee_id(data: object) -> None | Unset | UUID:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        manager_employee_id = _parse_manager_employee_id(d.pop("manager_employee_id", UNSET))
        ...
        employment_status = d.pop("employment_status", UNSET)
        ...
        def _parse_metadata(data: object) -> EmployeeCreateMetadataType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                metadata_type_0 = EmployeeCreateMetadataType0.from_dict(data)

                return metadata_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(EmployeeCreateMetadataType0 | None | Unset, data)
        ...
        employee_create.additional_properties = d
