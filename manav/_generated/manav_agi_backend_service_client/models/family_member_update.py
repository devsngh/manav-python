...
T = TypeVar("T", bound="FamilyMemberUpdate")


@_attrs_define
class FamilyMemberUpdate:
    """
    Attributes:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        is_alive: bool | None | Unset
        if isinstance(self.is_alive, Unset):
            is_alive = UNSET
        else:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_is_alive(data: object) -> bool | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        is_alive = _parse_is_alive(d.pop("is_alive", UNSET))
        ...
        family_member_update.additional_properties = d
        return family_member_update
