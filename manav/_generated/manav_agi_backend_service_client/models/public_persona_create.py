...
if TYPE_CHECKING:
    from ..models.public_persona_create_signature_elements_type_0 import PublicPersonaCreateSignatureElementsType0


T = TypeVar("T", bound="PublicPersonaCreate")


@_attrs_define
class PublicPersonaCreate:
    """
    Attributes:
        subject_type (str): bot / human
        persona_name (str):
        ...
        signature_elements (None | PublicPersonaCreateSignatureElementsType0 | Unset):
    ...
    signature_elements: None | PublicPersonaCreateSignatureElementsType0 | Unset = UNSET
    character_reference_id: None | Unset | UUID = UNSET
    is_public: bool | Unset = False
    additional_properties: dict[str, Any] = _attrs_field(init=False, factory=dict)

    def to_dict(self) -> dict[str, Any]:
        from ..models.public_persona_create_signature_elements_type_0 import (
            PublicPersonaCreateSignatureElementsType0,  # noqa: PLC0415
        )
        ...
        elif isinstance(self.signature_elements, PublicPersonaCreateSignatureElementsType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_signature_elements(data: object) -> None | PublicPersonaCreateSignatureElementsType0 | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                signature_elements_type_0 = PublicPersonaCreateSignatureElementsType0.from_dict(data)

                return signature_elements_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | PublicPersonaCreateSignatureElementsType0 | Unset, data)
        ...
        public_persona_create.additional_properties = d
        return public_persona_create
