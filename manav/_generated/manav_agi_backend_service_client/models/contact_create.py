...
if TYPE_CHECKING:
    from ..models.contact_create_metadata_type_0 import ContactCreateMetadataType0
    from ..models.contact_create_social_handles_type_0 import ContactCreateSocialHandlesType0
...
class ContactCreate:
    ...
    Attributes:
        ...
        social_handles (ContactCreateSocialHandlesType0 | None | Unset):
        last_engaged_at (datetime.datetime | None | Unset):
        metadata (ContactCreateMetadataType0 | None | Unset):
    """
    ...
    social_handles: ContactCreateSocialHandlesType0 | None | Unset = UNSET
    last_engaged_at: datetime.datetime | None | Unset = UNSET
    metadata: ContactCreateMetadataType0 | None | Unset = UNSET
    additional_properties: dict[str, Any] = _attrs_field(init=False, factory=dict)

    def to_dict(self) -> dict[str, Any]:
        from ..models.contact_create_metadata_type_0 import ContactCreateMetadataType0  # noqa: PLC0415
        from ..models.contact_create_social_handles_type_0 import ContactCreateSocialHandlesType0  # noqa: PLC0415
        ...
        elif isinstance(self.social_handles, ContactCreateSocialHandlesType0):
        ...
        if isinstance(self.metadata, Unset):
            metadata = UNSET
        elif isinstance(self.metadata, ContactCreateMetadataType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_social_handles(data: object) -> ContactCreateSocialHandlesType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                social_handles_type_0 = ContactCreateSocialHandlesType0.from_dict(data)

                return social_handles_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(ContactCreateSocialHandlesType0 | None | Unset, data)
        ...
        def _parse_metadata(data: object) -> ContactCreateMetadataType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                metadata_type_0 = ContactCreateMetadataType0.from_dict(data)

                return metadata_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(ContactCreateMetadataType0 | None | Unset, data)
