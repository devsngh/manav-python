...
if TYPE_CHECKING:
    from ..models.contract_create_metadata_type_0 import ContractCreateMetadataType0


T = TypeVar("T", bound="ContractCreate")
...
class ContractCreate:
    ...
    Attributes:
        contract_number (str):
        title (str):
        contract_type (str): msa / sow / nda / employment / vendor / customer / lease / license
        status (str | Unset):  Default: 'draft'.
        effective_date (datetime.date | None | Unset):
        expiry_date (datetime.date | None | Unset):
        auto_renew (bool | Unset):  Default: False.
        ...
        metadata (ContractCreateMetadataType0 | None | Unset):
    """
    ...
    metadata: ContractCreateMetadataType0 | None | Unset = UNSET
    additional_properties: dict[str, Any] = _attrs_field(init=False, factory=dict)

    def to_dict(self) -> dict[str, Any]:
        from ..models.contract_create_metadata_type_0 import ContractCreateMetadataType0  # noqa: PLC0415
        ...
        if isinstance(self.metadata, Unset):
            metadata = UNSET
        elif isinstance(self.metadata, ContractCreateMetadataType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_metadata(data: object) -> ContractCreateMetadataType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                metadata_type_0 = ContractCreateMetadataType0.from_dict(data)

                return metadata_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(ContractCreateMetadataType0 | None | Unset, data)
        ...
        contract_create.additional_properties = d
