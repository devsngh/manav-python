...
T = TypeVar("T", bound="SubAgentUserExtensionUpdate")


@_attrs_define
class SubAgentUserExtensionUpdate:
    """PUT payload — send model_id_override to set the override, null to clear.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        sub_agent_user_extension_update = cls(
            model_id_override=model_id_override,
        )

        sub_agent_user_extension_update.additional_properties = d
        return sub_agent_user_extension_update
