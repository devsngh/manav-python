...
if TYPE_CHECKING:
    from ..models.observer_finding_create_evidence_trace_ids_item import ObserverFindingCreateEvidenceTraceIdsItem
    from ..models.observer_finding_create_findings import ObserverFindingCreateFindings


T = TypeVar("T", bound="ObserverFindingCreate")


@_attrs_define
class ObserverFindingCreate:
    """POST /api/observability/training/findings — Pratyaksha logs a finding.
    ...
    Attributes:
        ...
        observer_role (str):
        finding_type (str):
        findings (ObserverFindingCreateFindings):
        evidence_trace_ids (list[ObserverFindingCreateEvidenceTraceIdsItem]):
        org_id (UUID):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.observer_finding_create_evidence_trace_ids_item import (
            ObserverFindingCreateEvidenceTraceIdsItem,  # noqa: PLC0415
        )
        from ..models.observer_finding_create_findings import ObserverFindingCreateFindings  # noqa: PLC0415
        ...
        findings = ObserverFindingCreateFindings.from_dict(d.pop("findings"))

        evidence_trace_ids = []
        _evidence_trace_ids = d.pop("evidence_trace_ids")
        for evidence_trace_ids_item_data in _evidence_trace_ids:
            evidence_trace_ids_item = ObserverFindingCreateEvidenceTraceIdsItem.from_dict(evidence_trace_ids_item_data)
        ...
        observer_finding_create.additional_properties = d
        return observer_finding_create
