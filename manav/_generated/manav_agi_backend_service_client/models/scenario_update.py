...
if TYPE_CHECKING:
    from ..models.scenario_update_expected_type_0 import ScenarioUpdateExpectedType0
...
class ScenarioUpdate:
    ...
    Attributes:
        ...
        expected (None | ScenarioUpdateExpectedType0 | Unset):
    ...
    expected: None | ScenarioUpdateExpectedType0 | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        from ..models.scenario_update_expected_type_0 import ScenarioUpdateExpectedType0  # noqa: PLC0415
        ...
        if isinstance(self.expected, Unset):
            expected = UNSET
        elif isinstance(self.expected, ScenarioUpdateExpectedType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_expected(data: object) -> None | ScenarioUpdateExpectedType0 | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                expected_type_0 = ScenarioUpdateExpectedType0.from_dict(data)

                return expected_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | ScenarioUpdateExpectedType0 | Unset, data)
