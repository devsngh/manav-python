...
if TYPE_CHECKING:
    from ..models.investor_update_metadata_type_0 import InvestorUpdateMetadataType0


T = TypeVar("T", bound="InvestorUpdate")
...
class InvestorUpdate:
    ...
    Attributes:
        ...
        metadata (InvestorUpdateMetadataType0 | None | Unset):
    """
    ...
    metadata: InvestorUpdateMetadataType0 | None | Unset = UNSET
    additional_properties: dict[str, Any] = _attrs_field(init=False, factory=dict)

    def to_dict(self) -> dict[str, Any]:
        from ..models.investor_update_metadata_type_0 import InvestorUpdateMetadataType0  # noqa: PLC0415
        ...
        if isinstance(self.metadata, Unset):
            metadata = UNSET
        elif isinstance(self.metadata, InvestorUpdateMetadataType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_metadata(data: object) -> InvestorUpdateMetadataType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                metadata_type_0 = InvestorUpdateMetadataType0.from_dict(data)

                return metadata_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(InvestorUpdateMetadataType0 | None | Unset, data)
        ...
        investor_update.additional_properties = d
