...
T = TypeVar("T", bound="PageContentResponse")
...
class PageContentResponse:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.content_response import ContentResponse  # noqa: PLC0415
        ...
        for sections_item_data in _sections:
            sections_item = ContentResponse.from_dict(sections_item_data)

            sections.append(sections_item)

        page_content_response = cls(
            page=page,
            sections=sections,
        )

        page_content_response.additional_properties = d
