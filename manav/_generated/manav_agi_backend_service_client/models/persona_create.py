...
if TYPE_CHECKING:
    from ..models.persona_create_content_preferences_type_0 import PersonaCreateContentPreferencesType0
    from ..models.persona_create_demographics_type_0 import PersonaCreateDemographicsType0
    from ..models.persona_create_psychographics_type_0 import PersonaCreatePsychographicsType0
...
class PersonaCreate:
    ...
    Attributes:
        ...
        demographics (None | PersonaCreateDemographicsType0 | Unset):
        psychographics (None | PersonaCreatePsychographicsType0 | Unset):
        pain_points (list[str] | None | Unset):
        goals (list[str] | None | Unset):
        preferred_channels (list[str] | None | Unset):
        content_preferences (None | PersonaCreateContentPreferencesType0 | Unset):
    ...
    demographics: None | PersonaCreateDemographicsType0 | Unset = UNSET
    psychographics: None | PersonaCreatePsychographicsType0 | Unset = UNSET
    pain_points: list[str] | None | Unset = UNSET
    goals: list[str] | None | Unset = UNSET
    preferred_channels: list[str] | None | Unset = UNSET
    content_preferences: None | PersonaCreateContentPreferencesType0 | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        from ..models.persona_create_content_preferences_type_0 import (
            PersonaCreateContentPreferencesType0,  # noqa: PLC0415
        )
        from ..models.persona_create_demographics_type_0 import PersonaCreateDemographicsType0  # noqa: PLC0415
        from ..models.persona_create_psychographics_type_0 import PersonaCreatePsychographicsType0  # noqa: PLC0415
        ...
        if isinstance(self.demographics, Unset):
            demographics = UNSET
        elif isinstance(self.demographics, PersonaCreateDemographicsType0):
        ...
        elif isinstance(self.psychographics, PersonaCreatePsychographicsType0):
        ...
        elif isinstance(self.content_preferences, PersonaCreateContentPreferencesType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_demographics(data: object) -> None | PersonaCreateDemographicsType0 | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                demographics_type_0 = PersonaCreateDemographicsType0.from_dict(data)

                return demographics_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | PersonaCreateDemographicsType0 | Unset, data)

        demographics = _parse_demographics(d.pop("demographics", UNSET))

        def _parse_psychographics(data: object) -> None | PersonaCreatePsychographicsType0 | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                psychographics_type_0 = PersonaCreatePsychographicsType0.from_dict(data)

                return psychographics_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | PersonaCreatePsychographicsType0 | Unset, data)
        ...
        def _parse_content_preferences(data: object) -> None | PersonaCreateContentPreferencesType0 | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                content_preferences_type_0 = PersonaCreateContentPreferencesType0.from_dict(data)

                return content_preferences_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | PersonaCreateContentPreferencesType0 | Unset, data)
