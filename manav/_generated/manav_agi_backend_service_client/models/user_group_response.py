...
T = TypeVar("T", bound="UserGroupResponse")
...
class UserGroupResponse:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_group_avatar_url(data: object) -> None | str:
            if data is None:
                return data
            return cast(None | str, data)

        group_avatar_url = _parse_group_avatar_url(d.pop("group_avatar_url"))
        ...
        user_group_response.additional_properties = d
