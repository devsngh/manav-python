...
if TYPE_CHECKING:
    from ..models.supplier_create_metadata_type_0 import SupplierCreateMetadataType0


T = TypeVar("T", bound="SupplierCreate")
...
class SupplierCreate:
    ...
    Attributes:
        ...
        status (str | Unset):  Default: 'pending_kyc'.
        ...
        is_preferred (bool | Unset):  Default: False.
        is_diversity_owned (bool | None | Unset):
        diversity_categories (list[str] | None | Unset):
        metadata (None | SupplierCreateMetadataType0 | Unset):
    """
    ...
    is_preferred: bool | Unset = False
    is_diversity_owned: bool | None | Unset = UNSET
    diversity_categories: list[str] | None | Unset = UNSET
    metadata: None | SupplierCreateMetadataType0 | Unset = UNSET
    additional_properties: dict[str, Any] = _attrs_field(init=False, factory=dict)

    def to_dict(self) -> dict[str, Any]:
        from ..models.supplier_create_metadata_type_0 import SupplierCreateMetadataType0  # noqa: PLC0415
        ...
        if isinstance(self.metadata, Unset):
            metadata = UNSET
        elif isinstance(self.metadata, SupplierCreateMetadataType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        is_preferred = d.pop("is_preferred", UNSET)
        ...
        def _parse_metadata(data: object) -> None | SupplierCreateMetadataType0 | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                metadata_type_0 = SupplierCreateMetadataType0.from_dict(data)

                return metadata_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | SupplierCreateMetadataType0 | Unset, data)
        ...
        supplier_create.additional_properties = d
