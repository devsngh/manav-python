...
T = TypeVar("T", bound="UserDirectCreate")


@_attrs_define
class UserDirectCreate:
    """Create user directly with password — no invite email, immediately active & verified.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        user_direct_create.additional_properties = d
        return user_direct_create
