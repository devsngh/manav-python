...
T = TypeVar("T", bound="CabinetTemplateFull")


@_attrs_define
class CabinetTemplateFull:
    """Full template — includes the YAML body.
    ...
    Attributes:
        ...
        placeholders (list[str] | None | Unset):
        created_by_user_id (None | Unset | UUID):
        created_by_bot_id (None | Unset | UUID):
        updated_by_user_id (None | Unset | UUID):
        updated_by_bot_id (None | Unset | UUID):
    """
    ...
    placeholders: list[str] | None | Unset = UNSET
    created_by_user_id: None | Unset | UUID = UNSET
    created_by_bot_id: None | Unset | UUID = UNSET
    updated_by_user_id: None | Unset | UUID = UNSET
    updated_by_bot_id: None | Unset | UUID = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        placeholders: list[str] | None | Unset
        if isinstance(self.placeholders, Unset):
            placeholders = UNSET
        elif isinstance(self.placeholders, list):
        ...
        updated_by_user_id: None | str | Unset
        if isinstance(self.updated_by_user_id, Unset):
            updated_by_user_id = UNSET
        elif isinstance(self.updated_by_user_id, UUID):
            updated_by_user_id = str(self.updated_by_user_id)
        else:
            updated_by_user_id = self.updated_by_user_id

        updated_by_bot_id: None | str | Unset
        if isinstance(self.updated_by_bot_id, Unset):
            updated_by_bot_id = UNSET
        elif isinstance(self.updated_by_bot_id, UUID):
            updated_by_bot_id = str(self.updated_by_bot_id)
        else:
            updated_by_bot_id = self.updated_by_bot_id
        ...
        if updated_by_user_id is not UNSET:
            field_dict["updated_by_user_id"] = updated_by_user_id
        if updated_by_bot_id is not UNSET:
            field_dict["updated_by_bot_id"] = updated_by_bot_id
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_placeholders(data: object) -> list[str] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, list):
                    raise TypeError()
                placeholders_type_0 = cast(list[str], data)

                return placeholders_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(list[str] | None | Unset, data)

        placeholders = _parse_placeholders(d.pop("placeholders", UNSET))
        ...
        def _parse_updated_by_user_id(data: object) -> None | Unset | UUID:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        updated_by_user_id = _parse_updated_by_user_id(d.pop("updated_by_user_id", UNSET))

        def _parse_updated_by_bot_id(data: object) -> None | Unset | UUID:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, str):
                    raise TypeError()
                updated_by_bot_id_type_0 = UUID(data)

                return updated_by_bot_id_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | Unset | UUID, data)

        updated_by_bot_id = _parse_updated_by_bot_id(d.pop("updated_by_bot_id", UNSET))

        cabinet_template_full = cls(
            id=id,
            bucket=bucket,
            path=path,
            version=version,
            ...
            updated_by_bot_id=updated_by_bot_id,
        )

        cabinet_template_full.additional_properties = d
        return cabinet_template_full
