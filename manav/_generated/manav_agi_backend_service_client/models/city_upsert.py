...
if TYPE_CHECKING:
    from ..models.city_upsert_metadata_type_0 import CityUpsertMetadataType0


T = TypeVar("T", bound="CityUpsert")


@_attrs_define
class CityUpsert:
    """Caller may pre-assign id for deterministic upsert; server generates if absent.
    ...
    Attributes:
        ...
        lat (float | None | str | Unset):
        lon (float | None | str | Unset):
        ...
        metadata (CityUpsertMetadataType0 | None | Unset):
    ...
    lat: float | None | str | Unset = UNSET
    lon: float | None | str | Unset = UNSET
    ...
    metadata: CityUpsertMetadataType0 | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        from ..models.city_upsert_metadata_type_0 import CityUpsertMetadataType0  # noqa: PLC0415
        ...
        if isinstance(self.metadata, Unset):
            metadata = UNSET
        elif isinstance(self.metadata, CityUpsertMetadataType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_lat(data: object) -> float | None | str | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_lon(data: object) -> float | None | str | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_metadata(data: object) -> CityUpsertMetadataType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                metadata_type_0 = CityUpsertMetadataType0.from_dict(data)

                return metadata_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(CityUpsertMetadataType0 | None | Unset, data)
        ...
        city_upsert.additional_properties = d
        return city_upsert
