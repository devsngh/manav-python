...
T = TypeVar("T", bound="RecordTermSheetRequest")


@_attrs_define
class RecordTermSheetRequest:
    """
    Attributes:
        term_sheet_asset_id (UUID):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        term_sheet_asset_id = UUID(d.pop("term_sheet_asset_id"))
        ...
        record_term_sheet_request = cls(
            term_sheet_asset_id=term_sheet_asset_id,
            signed_at=signed_at,
        )

        record_term_sheet_request.additional_properties = d
        return record_term_sheet_request
