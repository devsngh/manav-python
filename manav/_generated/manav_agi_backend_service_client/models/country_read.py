...
if TYPE_CHECKING:
    from ..models.country_read_metadata_type_0 import CountryReadMetadataType0
...
class CountryRead:
    ...
    Attributes:
        ...
        hdi (None | str | Unset):
        internet_penetration_pct (None | str | Unset):
        tier (None | str | Unset):
        ...
        metadata (CountryReadMetadataType0 | None | Unset):
    ...
    hdi: None | str | Unset = UNSET
    internet_penetration_pct: None | str | Unset = UNSET
    ...
    metadata: CountryReadMetadataType0 | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        from ..models.country_read_metadata_type_0 import CountryReadMetadataType0  # noqa: PLC0415
        ...
        if isinstance(self.metadata, Unset):
            metadata = UNSET
        elif isinstance(self.metadata, CountryReadMetadataType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_hdi(data: object) -> None | str | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_internet_penetration_pct(data: object) -> None | str | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_metadata(data: object) -> CountryReadMetadataType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                metadata_type_0 = CountryReadMetadataType0.from_dict(data)

                return metadata_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(CountryReadMetadataType0 | None | Unset, data)
