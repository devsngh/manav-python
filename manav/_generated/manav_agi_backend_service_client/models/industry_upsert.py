...
if TYPE_CHECKING:
    from ..models.industry_upsert_metadata_type_0 import IndustryUpsertMetadataType0


T = TypeVar("T", bound="IndustryUpsert")


@_attrs_define
class IndustryUpsert:
    """
    Attributes:
        name (str):
        naics_code (str):
        ...
        metadata (IndustryUpsertMetadataType0 | None | Unset):
    ...
    metadata: IndustryUpsertMetadataType0 | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        from ..models.industry_upsert_metadata_type_0 import IndustryUpsertMetadataType0  # noqa: PLC0415
        ...
        if isinstance(self.metadata, Unset):
            metadata = UNSET
        elif isinstance(self.metadata, IndustryUpsertMetadataType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_metadata(data: object) -> IndustryUpsertMetadataType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                metadata_type_0 = IndustryUpsertMetadataType0.from_dict(data)

                return metadata_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(IndustryUpsertMetadataType0 | None | Unset, data)
        ...
        industry_upsert.additional_properties = d
        return industry_upsert
