...
T = TypeVar("T", bound="InternalToolParameterCreate")


@_attrs_define
class InternalToolParameterCreate:
    """
    Attributes:
        parameter_name (str):
        parameter_type (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        internal_tool_parameter_create = cls(
            parameter_name=parameter_name,
            parameter_type=parameter_type,
        ...
        internal_tool_parameter_create.additional_properties = d
        return internal_tool_parameter_create
