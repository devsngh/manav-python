...
T = TypeVar("T", bound="PositionAssignRequest")


@_attrs_define
class PositionAssignRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        position_assign_request = cls(
            user_id=user_id,
            org_id=org_id,
        )

        position_assign_request.additional_properties = d
        return position_assign_request
