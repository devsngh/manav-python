...
if TYPE_CHECKING:
    from ..models.social_account_update_metadata_type_0 import SocialAccountUpdateMetadataType0


T = TypeVar("T", bound="SocialAccountUpdate")
...
class SocialAccountUpdate:
    ...
    Attributes:
        ...
        metadata (None | SocialAccountUpdateMetadataType0 | Unset):
    """
    ...
    metadata: None | SocialAccountUpdateMetadataType0 | Unset = UNSET
    additional_properties: dict[str, Any] = _attrs_field(init=False, factory=dict)

    def to_dict(self) -> dict[str, Any]:
        from ..models.social_account_update_metadata_type_0 import SocialAccountUpdateMetadataType0  # noqa: PLC0415
        ...
        if isinstance(self.metadata, Unset):
            metadata = UNSET
        elif isinstance(self.metadata, SocialAccountUpdateMetadataType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_metadata(data: object) -> None | SocialAccountUpdateMetadataType0 | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                metadata_type_0 = SocialAccountUpdateMetadataType0.from_dict(data)

                return metadata_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | SocialAccountUpdateMetadataType0 | Unset, data)

        metadata = _parse_metadata(d.pop("metadata", UNSET))

        social_account_update = cls(
        ...
        social_account_update.additional_properties = d
