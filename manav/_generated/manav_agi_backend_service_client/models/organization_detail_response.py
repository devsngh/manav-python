...
class OrganizationDetailResponse:
    ...
    Attributes:
        ...
        custom_metadata (None | OrganizationDetailResponseCustomMetadataType0 | Unset):
        is_verified (bool | Unset):  Default: False.
        subscription_tier (None | str | Unset):
        pricing_region (str | Unset):  Default: 'global'.
        created_by_user_id (None | Unset | UUID):
        member_count (int | None | Unset):  Default: 0.
        members (list[OrganizationMemberResponse] | Unset):
    """
    ...
    custom_metadata: None | OrganizationDetailResponseCustomMetadataType0 | Unset = UNSET
    is_verified: bool | Unset = False
    subscription_tier: None | str | Unset = UNSET
    pricing_region: str | Unset = "global"
    created_by_user_id: None | Unset | UUID = UNSET
    member_count: int | None | Unset = 0
    members: list[OrganizationMemberResponse] | Unset = UNSET
    additional_properties: dict[str, Any] = _attrs_field(init=False, factory=dict)

    def to_dict(self) -> dict[str, Any]:
        from ..models.organization_detail_response_custom_metadata_type_0 import (
            OrganizationDetailResponseCustomMetadataType0,  # noqa: PLC0415
        )
        ...
        elif isinstance(self.custom_metadata, OrganizationDetailResponseCustomMetadataType0):
        ...
        if pricing_region is not UNSET:
            field_dict["pricing_region"] = pricing_region
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        from ..models.organization_member_response import OrganizationMemberResponse  # noqa: PLC0415
        ...
        def _parse_custom_metadata(data: object) -> None | OrganizationDetailResponseCustomMetadataType0 | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                custom_metadata_type_0 = OrganizationDetailResponseCustomMetadataType0.from_dict(data)

                return custom_metadata_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | OrganizationDetailResponseCustomMetadataType0 | Unset, data)
        ...
        pricing_region = d.pop("pricing_region", UNSET)
        ...
        if _members is not UNSET:
            ...
            for members_item_data in _members:
                members_item = OrganizationMemberResponse.from_dict(members_item_data)

                members.append(members_item)

        organization_detail_response = cls(
            name=name,
            type_=type_,
            id=id,
            status=status,
        ...
        organization_detail_response.additional_properties = d
        return organization_detail_response
