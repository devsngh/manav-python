...
if TYPE_CHECKING:
    from ..models.tool_detail_response_datasource_mappings_item import ToolDetailResponseDatasourceMappingsItem
...
class ToolDetailResponse:
    """Extended response with datasource mappings - now same as ToolResponse
    ...
    Attributes:
        ...
        datasource_mappings (list[ToolDetailResponseDatasourceMappingsItem] | Unset):
    ...
    datasource_mappings: list[ToolDetailResponseDatasourceMappingsItem] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.tool_detail_response_datasource_mappings_item import (
            ToolDetailResponseDatasourceMappingsItem,  # noqa: PLC0415
        )
        ...
        if _datasource_mappings is not UNSET:
            ...
            for datasource_mappings_item_data in _datasource_mappings:
                datasource_mappings_item = ToolDetailResponseDatasourceMappingsItem.from_dict(
                    datasource_mappings_item_data
                )
