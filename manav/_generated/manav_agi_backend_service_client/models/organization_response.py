...
if TYPE_CHECKING:
    from ..models.organization_response_custom_metadata_type_0 import OrganizationResponseCustomMetadataType0
...
class OrganizationResponse:
    ...
    Attributes:
        ...
        custom_metadata (None | OrganizationResponseCustomMetadataType0 | Unset):
    ...
    custom_metadata: None | OrganizationResponseCustomMetadataType0 | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        from ..models.organization_response_custom_metadata_type_0 import (
            OrganizationResponseCustomMetadataType0,  # noqa: PLC0415
        )
        ...
        elif isinstance(self.custom_metadata, OrganizationResponseCustomMetadataType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_custom_metadata(data: object) -> None | OrganizationResponseCustomMetadataType0 | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                custom_metadata_type_0 = OrganizationResponseCustomMetadataType0.from_dict(data)

                return custom_metadata_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | OrganizationResponseCustomMetadataType0 | Unset, data)
