...
if TYPE_CHECKING:
    from ..models.ip_asset_create_metadata_type_0 import IPAssetCreateMetadataType0


T = TypeVar("T", bound="IPAssetCreate")
...
class IPAssetCreate:
    """
    Attributes:
        ip_type (str): trademark / patent / copyright / domain / trade_secret
        name (str):
        ...
        metadata (IPAssetCreateMetadataType0 | None | Unset):
    """
    ...
    metadata: IPAssetCreateMetadataType0 | None | Unset = UNSET
    additional_properties: dict[str, Any] = _attrs_field(init=False, factory=dict)

    def to_dict(self) -> dict[str, Any]:
        from ..models.ip_asset_create_metadata_type_0 import IPAssetCreateMetadataType0  # noqa: PLC0415
        ...
        if isinstance(self.metadata, Unset):
            metadata = UNSET
        elif isinstance(self.metadata, IPAssetCreateMetadataType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_metadata(data: object) -> IPAssetCreateMetadataType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                metadata_type_0 = IPAssetCreateMetadataType0.from_dict(data)

                return metadata_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(IPAssetCreateMetadataType0 | None | Unset, data)
        ...
        ip_asset_create.additional_properties = d
        return ip_asset_create
