...
if TYPE_CHECKING:
    from ..models.organization_update_custom_metadata_type_0 import OrganizationUpdateCustomMetadataType0
...
class OrganizationUpdate:
    ...
    Attributes:
        ...
        custom_metadata (None | OrganizationUpdateCustomMetadataType0 | Unset):
    """
    ...
    custom_metadata: None | OrganizationUpdateCustomMetadataType0 | Unset = UNSET
    additional_properties: dict[str, Any] = _attrs_field(init=False, factory=dict)

    def to_dict(self) -> dict[str, Any]:
        from ..models.organization_update_custom_metadata_type_0 import (
            OrganizationUpdateCustomMetadataType0,  # noqa: PLC0415
        )
        ...
        elif isinstance(self.custom_metadata, OrganizationUpdateCustomMetadataType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_custom_metadata(data: object) -> None | OrganizationUpdateCustomMetadataType0 | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                custom_metadata_type_0 = OrganizationUpdateCustomMetadataType0.from_dict(data)

                return custom_metadata_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | OrganizationUpdateCustomMetadataType0 | Unset, data)
